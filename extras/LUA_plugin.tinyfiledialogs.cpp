/*_________
 /         \ LUA_plugin.tinyfiledialogs.cpp v2.7.3 [January 23, 2017] zlib licence
 |tiny file| LUA bindings created [2016]
...
please, let me now of any improvement that could make it more generic.
